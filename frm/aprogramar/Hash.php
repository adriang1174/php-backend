...
class Mdi_Util_Hash {
	...
	public static function getMD5( $str ) {
		...
		return md5( CONFIG_HASH_SALT . $str );
	}

	public static function getGuid( $prefix = '' ) {

		return self::getMD5( $prefix . mt_rand() . uniqid( $prefix . mt_rand(), true ) );
	}

	public static function getGuid32Hex() {
