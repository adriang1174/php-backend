...
//				$res = parent::_obtenerListadoPaginado (  $campos="*",$from=DB_PREFIX . self::TABLE,$pagina=1,$reg_x_pagina=50,$filtros=$condicion ,$orden=null);
	 			...
	 			{
	 				$tipfac = $this->TIPFAC;
	 				$codfacd = $this->CODFACD + 10000;
	 				$codfach = $this->CODFACH + 10000;

	 			}
	 			elseif( $this->TIPFAC == "'77'") 
	 			{
	 				$tipfac = "'7'";
	 				$codfacd = $this->CODFACD + 80000;
	 				$codfach = $this->CODFACH + 80000;	 				
	 			}
	 			elseif ($this->TIPFAC == "'777'") {
	 				$tipfac = "'7'";
	 				$codfacd = $this->CODFACD + 90000;
	 				$codfach = $this->CODFACH + 90000;
	 			}
	 			else
	 			{
	 				$tipfac = $this->TIPFAC;
				...
				foreach($res as $row)
				{
						...
						if ($row['TIPFAC']== "'7'")
						{
							if($row['CODFAC'] > 10000 and $row['CODFAC'] < 80000 )
							{
								$tipfac = '51';
								$codfac = $row['CODFAC']  - 10000;
							}
							if($row['CODFAC'] > 80000 and $row['CODFAC'] < 90000 )
							{
								$tipfac = '53';
								$codfac = $row['CODFAC']  - 80000;
							}
							else
							{
								$tipfac = '52';
								$codfac = $row['CODFAC']  - 90000;
							}
							$row['CODFAC'] = $codfac;
							$row['TIPFAC'] = $tipfac;
