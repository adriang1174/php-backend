...
<?php
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreference.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferencePayer.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferenceItems.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferencePaymentMethods.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferenceBackUrls.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferenceExcludedPaymentMethods.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/checkoutPreferenceExcludedPaymentTypes.php";
...
class CheckoutService {
	public function create_checkout_preference ($checkoutPreferenceData,$accessToken) {//checkoutPreferenceData must be a CheckoutPreferenceData Object, accessToken must be string
		...
		curl_setopt($preferenceConnect , CURLOPT_SSL_VERIFYHOST , false );		
	...
	public function get_checkout_preference($preferenceId,$accessToken) {// both must be strings
		...
		curl_setopt($getPreferenceConnect , CURLOPT_SSL_VERIFYPEER , false );
		curl_setopt($getPreferenceConnect , CURLOPT_SSL_VERIFYHOST , false );			
	...
	public function update_checkout_preference ($preferenceId,$updateData,$accessToken) { // id y accessToken must be string, updatedata must be checkoutPreferenceData Object
		...
		curl_setopt($putPreferenceConnect , CURLOPT_SSL_VERIFYPEER , false );
		curl_setopt($putPreferenceConnect , CURLOPT_SSL_VERIFYHOST , false );
