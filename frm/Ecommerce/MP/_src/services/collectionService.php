...
<?php
require_once PATH_FRM."/Ecommerce/MP/src/classes/collection.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/collectionPayer.php";
require_once PATH_FRM."/Ecommerce/MP/src/classes/collectionPayerPhone.php";
...
class CollectionService {
	...
	public function search_collection ($filters,$accessToken) { //filters must be an array, accessToken must be a string
		...
		curl_setopt($searchCollectionConnect , CURLOPT_SSL_VERIFYPEER , false );
		curl_setopt($searchCollectionConnect , CURLOPT_SSL_VERIFYHOST , false );		
